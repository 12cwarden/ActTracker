...
///test to make sure class is capturing
...
class App {
  ...
  _loadMap(position) {
    ...
    // L.marker(coords)
    //   .addTo(map)
    //   .bindPopup('Click to add your<br> workout!')
    //   .openPopup();
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Inputs are not numbers!');
      if (!positiveNums(distance, duration, cadence))
        return alert('Inputs are not positive!');
    ...
    if (type === 'cycling') {
      ...
      if (
        ...
        return alert('Inputs are not numbers!');
      if (!positiveNums(distance, duration))
        return alert('Inputs are not positive!');
